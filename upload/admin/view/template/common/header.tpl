...
<header id="header" class="navbar navbar-static-top">
  <div class="navbar-header">
    ...
    <?php } ?>
    <a href="<?php echo $home; ?>" class="navbar-brand"><img id="admin-logo" src="view/image/logo.png" alt="<?php echo $heading_title; ?>" title="<?php echo $heading_title; ?>" /></a></div>
  <?php if ($logged) { ?>
  <ul class="nav pull-right">
    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><?php if($alerts > 0) { ?><span class="label label-danger pull-left"><?php echo $alerts; ?></span><?php } ?> <i class="fa fa-bell fa-lg"></i></a>
      <ul class="dropdown-menu dropdown-menu-right alerts-dropdown">
		...
		<li class="divider"></li>
        <li class="dropdown-header"><?php echo $text_used_product; ?></li>
        <li><a href="<?php echo $used_product; ?>"><span class="label label-danger pull-right"><?php echo $used_product_total; ?></span><?php echo $text_approval; ?></a></li>
        <li class="divider"></li>
