...
class ControllerCommonHeader extends Controller {
	public function index() {
		// SuperMenu
        $this->document->addScript('catalog/view/javascript/supermenu/supermenu-responsive.js');
        $this->document->addScript('catalog/view/javascript/supermenu/jquery.hoverIntent.minified.js');
		$this->document->addStyle('catalog/view/javascript/supermenu/supermenu.css');
		...
		foreach ($categories as $category) {
			if ($category['top']) {
				...
				$data['categories'][] = array(
					...
					'href'     => $href,//$this->url->link('product/category', 'path=' . $category['category_id']),
					//supermenu
